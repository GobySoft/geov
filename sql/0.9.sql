...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_core` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `core_connected` (
  `connected_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `connected_ip` char(15) COLLATE utf8_unicode_ci NOT NULL,
  `connected_userid` int(10) unsigned NOT NULL,
  `connected_profileid` int(10) unsigned DEFAULT NULL,
  `connected_lasttime` double DEFAULT NULL COMMENT 'unix epoch',
  `connected_lastdataid` int(10) unsigned DEFAULT '0',
  `connected_client` int(4) NOT NULL COMMENT 'type of connection: 1 = website, 2 = google earth',
  `connected_playback` int(2) DEFAULT NULL COMMENT '0 = stopped, 1 = playing, 2 = pause',
  `connected_playbackcount` double DEFAULT NULL COMMENT 'seconds into the playback',
  `connected_playbackstep` int(6) DEFAULT NULL,
  `connected_message` text COLLATE utf8_unicode_ci,
  `connected_reload` tinyint(1) NOT NULL DEFAULT '1',
  `connected_lastrange` int(11) DEFAULT NULL,
  `connected_lasttilt` int(4) DEFAULT NULL,
...
CREATE TABLE `core_connected_vehicle` (
  `c_vehicle_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `c_vehicle_connectedid` int(11) unsigned NOT NULL,
  `c_vehicle_vehicleid` int(11) unsigned NOT NULL,
  `c_vehicle_lastdid` int(11) DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=24020 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_data` (
  ...
  `data_vehicleid` int(11) DEFAULT NULL,
  ...
  `data_quality` int(3) NOT NULL DEFAULT '10' COMMENT 'quality number where 0 is the best possible',
  `data_userid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`data_id`),
  KEY `data_vehicleid` (`data_vehicleid`),
  KEY `data_time` (`data_time`)
) ENGINE=MyISAM AUTO_INCREMENT=3247338 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_imported_alogs` (
  `alog_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alog_vehicleid` int(11) NOT NULL,
  `alog_filename` varchar(2000) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`alog_id`)
...
CREATE TABLE `core_module` (
  ...
  `module_refresh_time` int(4) NOT NULL DEFAULT '5' COMMENT 'refresh time of ge_viewer.php in seconds',
...
CREATE TABLE `core_profile` (
  ...
  `profile_tzone` int(3) NOT NULL DEFAULT '-5',
  `profile_sort` enum('name','type','owner') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'type',
  `profile_createtime` double NOT NULL,
  `profile_mode` enum('realtime','playback','history') COLLATE utf8_unicode_ci NOT NULL,
  `profile_rate` float NOT NULL DEFAULT '1',
  `profile_starttime` double DEFAULT NULL,
  `profile_endtime` double DEFAULT NULL,
  `profile_vfollowid` int(10) DEFAULT NULL,
  ...
  `profile_fixediconsize` int(11) NOT NULL DEFAULT '1000' COMMENT 'size (in meters square) for fixed icon size',
...
CREATE TABLE `core_profile_module` (
  `p_module_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `p_module_profileid` int(10) unsigned NOT NULL,
  `p_module_moduleid` int(11) NOT NULL,
...
CREATE TABLE `core_profile_vehicle` (
  `p_vehicle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `p_vehicle_profileid` int(10) unsigned NOT NULL,
  `p_vehicle_vehicleid` int(10) unsigned NOT NULL,
  ...
  `p_vehicle_color` char(8) COLLATE utf8_unicode_ci DEFAULT 'FFFFFFFF' COMMENT 'AABBGGRR',
...
) ENGINE=MyISAM AUTO_INCREMENT=1388 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_user` (
  ...
  `user_active_profileid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`user_id`)
...
CREATE TABLE `core_vehicle` (
  ...
  `vehicle_image` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'geov/images/default.png' COMMENT 'file name of image relative to web root',
  `vehicle_disabled` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'is the vehicle disabled from view in all profiles',
  PRIMARY KEY (`vehicle_id`)
) ENGINE=MyISAM AUTO_INCREMENT=672704001 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_vehicle_default` (
  `v_default_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_moos_cp` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `moos_cp_data` (
  ...
  `data_variable` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `data_value` text COLLATE utf8_unicode_ci NOT NULL,
  `data_userid` int(11) NOT NULL,
  PRIMARY KEY (`data_id`),
  KEY `data_time` (`data_time`)
) ENGINE=MyISAM AUTO_INCREMENT=14953 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_moos_ctd` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_moos_depth` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_moos_mseas` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `moos_mseas_data` (
  ...
  PRIMARY KEY (`data_id`),
  KEY `data_time` (`data_time`)
) ENGINE=MyISAM AUTO_INCREMENT=14978 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_moos_nafcon_target` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `moos_nafcon_target_data` (
  ...
  PRIMARY KEY (`data_id`),
  KEY `data_time` (`data_time`)
) ENGINE=MyISAM AUTO_INCREMENT=6794 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `moos_nafcon_target_profile` (
  ...
  `profile_modemlookup` varchar(512) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'modules/moos_nafcon_target/modemidlookup.txt',
  PRIMARY KEY (`profile_id`)
) ENGINE=MyISAM AUTO_INCREMENT=171 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `geov_moos_opgrid` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `moos_opgrid_data` (
  ...
  PRIMARY KEY (`data_id`),
  KEY `data_time` (`data_time`)
) ENGINE=MyISAM AUTO_INCREMENT=153703 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `moos_opgrid_profile` (
  ...
  `profile_opbox` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
  `profile_opbox_latlong` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
  `profile_datumlat` double NOT NULL,
  `profile_datumlon` double NOT NULL,
  ...
  `profile_markers` text COLLATE utf8_unicode_ci NOT NULL,
  `profile_reload` tinyint(1) NOT NULL DEFAULT '1',
  `profile_autoshow` tinyint(1) NOT NULL DEFAULT '1',
  `profile_autoshowexpand` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`profile_id`)
) ENGINE=MyISAM AUTO_INCREMENT=171 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `moos_opgrid_profile_vehicle` (
  ...
  `p_vehicle_viewpoint` varchar(512) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  `p_vehicle_viewpolygon` varchar(512) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  PRIMARY KEY (`p_vehicle_id`),
  UNIQUE KEY `p_vehicle_profileid_2` (`p_vehicle_profileid`,`p_vehicle_vehicleid`),
  KEY `p_vehicle_profileid` (`p_vehicle_profileid`),
  KEY `p_vehicle_vehicleid` (`p_vehicle_vehicleid`)
...
-- Dump completed on 2018-02-01 17:10:18
USE `geov_core`;
-- MySQL dump 10.13  Distrib 5.7.19, for Linux (x86_64)
--
-- Host: localhost    Database: geov_core
