...
) ENGINE=MyISAM AUTO_INCREMENT=24050 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=3375603 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `moos_opgrid_data` (
  ...
  PRIMARY KEY (`data_id`),
  KEY `data_time` (`data_time`)
) ENGINE=MyISAM AUTO_INCREMENT=155504 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `moos_opgrid_profile` (
  ...
  `profile_opbox` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `profile_opbox_latlong` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `profile_markers` text COLLATE utf8_unicode_ci,
...
-- Dump completed on 2018-02-01 12:09:45
USE `geov_core`;
-- MySQL dump 10.13  Distrib 5.7.21, for Linux (x86_64)
--
-- Host: localhost    Database: geov_core
